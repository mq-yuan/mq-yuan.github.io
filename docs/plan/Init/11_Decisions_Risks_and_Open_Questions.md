...
| ---- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| OQ-1 | **Bio + one-line research tagline** (hero + about). Portrait added 2026-08-25; undergrad facts (Tianjin University, advisor Bing Cao) added to About. Bio/tagline wording still pending — author deferred                          | Phase 8 exit                                                                                            | Provisional factual tagline in use |
...
| OQ-3 | **Signature visual final pick** among Phase 4 prototypes; comparison in `reports/phase4-experiments.md`, preview via `pnpm dev` → `/experiments/{splat,panorama,pointcloud,fbm}`                                                   | Phase 5 proceeded with A per doc 09 fallback rule; author can overrule anytime (scene swap is one line) | A polished; B/C/D kept in registry |
| OQ-4 | **Accent color** preference (working value: ink blue `#2F5DA8`)                                                                                                                                                                    | none (tune anytime)                                                                                     | Working value used                 |
| OQ-5 | Nav label "Writing" vs "Blog" — author deferred 2026-08-25, keeping "Writing"                                                                                                                                                      | none                                                                                                    | "Writing"                          |
